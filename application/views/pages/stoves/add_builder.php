	...
	<div class="container-fluid">
		...
		<div class="card">
			...
			<div class="body">
	        	...
	        	<?php endif; ?>
				<?php echo form_open('/stoves/add/builder');?>
					<div class="row clearfix">
						<div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="first_name" name="StoveBuilder" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        	<button type="submit" class="btn btn-primary m-t-15 waves-effect">Post Builder</button>
                        </div>
					</div>
				<?php echo form_close(); ?>
			</div>
